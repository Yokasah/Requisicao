            ...
            <div class="col-md-12">
                <div style="width: 1070px" class="card shadow-3">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 ">
                                <h5>Minhas Requisição</h5>
                                <hr>
                                <div class="form-group table-responsive">
                                    <table style="max-height:80%;overflow:auto;display:inline-block;" class="table">
										...
										while ( $row = mysqli_fetch_assoc( $sql ) ) {
                                            if($_SESSION['nomeUser'] == $row['requisitante_requisicao']){
                                                echo "<tr>";
                                                ...
                                                echo "<td><a href='index.php'>Editar</a> <a href='index.php'>Cancelar</a></td>";
                                                echo "</tr>";
                                            }
										}
										echo "</tr>";
